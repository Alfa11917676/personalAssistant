...
def _welcomeFunction():
    audio("Welcome Back Arnab")
    hour=datetime.datetime.now().hour
    if hour<12:
        audio("Good Morning Boss!")
    elif hour>=12 and hour<16:
        audio("Good afternoon Boss!")
    elif hour>=16 and hour<21:
        audio("Good evening Boss!")
    else:
        ...
        if 'time' in spech:
          ...
          # audio("Searching...")
            ...
            try:
                ...
                to=receiver
                _sendEmail(to,content)
                audio("Arnab your email to email address %s whose content was"%receiver)
                audio(content)
            ...
            audio("What should I note Arnab?")
            print("What should I note Arnab?")
            note=_takeCommand()
